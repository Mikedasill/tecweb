...
<p><small>Servidor:
  <?php echo htmlspecialchars(PHP_VERSION . ' / ' . PHP_SAPI, ENT_QUOTES, 'UTF-8'); ?>
...
foreach ($explicacion as $var => $why) {
  echo htmlspecialchars($var, ENT_QUOTES, 'UTF-8') . ' &rarr; ' .
       htmlspecialchars($why, ENT_QUOTES, 'UTF-8') . '<br />';
}
unset($explicacion);
?>
</div>
...
$z[0] = 'MySQL'; // rompe la referencia anterior
echo '$z = '; print_r($z);
...
echo '<br />echo de $c &rarr; ' . boolToText($c) . '<br />';
echo 'echo de $e &rarr; ' . boolToText($e) . '<br />';
...
<p class="mono">Fin de P05 • <?php echo date('c'); ?></p>

<!-- Badge de validación (lleva al validador con la URL actual) -->
<p>
